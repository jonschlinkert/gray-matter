...
> NOTE: in this release we have switched over to ES Modules in the core code but both ESM and CJS are exported for users of this library.
...
Both JS and TS use the modern "import" signature that hopefully you are familiar with:
