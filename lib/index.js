...
function matter(str, options) {
  ...
  var opts = options || {};
  opts.lang = opts.lang || matter.defaultLang;
...
matter.register = parsers;
matter.defaultLang = 'yaml';

/**
 * Requires cache
 */

var YAML = matter.parsers.requires.yaml || (matter.parsers.requires.yaml = require('./parsers/js-yaml'));
